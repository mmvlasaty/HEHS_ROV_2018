...
void enableI2CPins()
{
  ...
  isI2CEnabled = true;
  Firmata.sendString("I2C: successfully enabled - 253");
...
Firmata.sendString("I2C: disabled - 262");
  queryIndex = -1;
}
...
Firmata.sendString("I2C: disabled by PIN_MODE_I2C && isI2CEnabled && mode != PIN_MODE_I2C - 353");
    disableI2CPins();
  }
...
// Firmata.sendString(slaveAddress);
         break;
        case I2C_READ:
          if (argc == 6) {
...
Firmata.sendString("I2C: argc > 1 && delayTime > 0 - 677");

      if (!isI2CEnabled) {
        enableI2CPins();
Firmata.sendString("I2C: not enabled so enable i2c - 681");
      }
...
Firmata.sendString("I2C: is pin i2c - 746");
        }
#ifdef FIRMATA_SERIAL_FEATURE
...
void systemResetCallback()
{
  ...
  if (isI2CEnabled) {
    disableI2CPins();
Firmata.sendString("I2C: disabled by firmata serial feature - 804");
  }
